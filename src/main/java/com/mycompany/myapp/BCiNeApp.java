...
public class BCiNeApp {

    private static final Logger log = LoggerFactory.getLogger(BCiNeApp.class);

    private final Environment env;

    public BCiNeApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(BCiNeApp.class);
